...
const ZH: Record<string, string> = {
  ...
  "Name a transfer, a volume, or wells — for example Transfer 50 µL from A1 to B1.":
    "请写出操作、体积或孔位，例如：从 A1 转移 50 µL 到 B1。",
  "Change robot": "更换仪器",
  "Notes attached": "已附备注",
  ...
  "Choose file": "选择文件",
  "Transfer 50 µL A1→B1": "转移 50 µL A1→B1",
  "Prepare a PCR mix": "配制 PCR 混合液",
  "Typical deck": "常用台面",
  "Checking with you…": "正在向你确认…",
  "Writing the protocol…": "正在写方案…",
  "Writing the script…": "正在写脚本…",
  "Laying out the steps…": "正在列出步骤…",
  "Checking bench constraints…": "正在检查台面约束…",
  "Putting the deck on Stage…": "正在把台面放到预览…",
  "Asked you to confirm": "已请你确认",
  "Wrote the protocol": "已写方案",
  "Wrote the script": "已写脚本",
  "Laid out the steps": "已列出步骤",
  "Checked bench constraints": "已检查台面约束",
  "Deck is on Stage": "台面已在预览中",
  "Thought it through": "已想过",
  "Thinking it through…": "正在思考…",
  "Checked the bench — deck is up": "台面检查完成 — 预览已打开",
  "Checking the bench — deck next…": "正在检查台面 — 接着是预览…",
  Passed: "通过",
  Failed: "未通过",
  "Still going": "进行中",
  "Confirms and checks land here.": "确认与校验会出现在这里。",
  Start: "开始",
  "After you replied": "你回复之后",
  More: "更多",
  "standard deck": "标准台面",
  "Earlier messages stay in the language they were written in.": "此前的消息保持生成时的语言。",
  ...
  Compile: "编译",
  Review: "复核",
  "This is not a live-hardware safety clearance.": "这不是上机安全放行。",
  "Hamilton STAR, Hamilton Vantage, and Tecan Fluent are authoring-only — nothing runs on the instrument from here.":
    "Hamilton STAR、Hamilton Vantage 与 Tecan Fluent 仅用于编写 — 不会从这里在仪器上运行。",
  "On-screen Watch is not a run on the robot.": "屏幕观看不是在仪器上运行。",
  "Standard deck (assumed, then confirmed in chat)": "标准台面（先假定，后在对话中确认）",
  "Deck as last confirmed": "以最近确认的台面为准",
  "Volumes, wells, and deck as confirmed in chat": "体积、孔位与台面以对话确认的为准",
  "Resize chat": "调整对话宽度",
  "Right stage": "右侧台面",
  Language: "语言",
  English: "English",
  ...
  "Steps not listed yet": "步骤尚未列出",
  "liquid-handling step": "个移液步骤",
  "liquid-handling steps": "个移液步骤",
  step: "步",
  steps: "步骤",
  tips: "枪头",
  "PCR plate": "PCR 板",
  ...
  thermocycler: "热循环仪",
  labware: "耗材",
  "300 µL tips": "300 µL 枪头",
  "1000 µL tips": "1000 µL 枪头",
  "96-well plate": "96 孔板",
  "12-well reservoir": "12 孔储液槽",
  "200 µL DiTi tips": "200 µL DiTi 枪头",
  "Standard deck": "标准台面",
