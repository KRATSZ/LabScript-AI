...
| Paper draft and paper-facing materials | [`paper/`](paper/) | Manuscript material; layout in [`paper/README.md`](paper/README.md). Canonical draft: [`paper/.laipaper/main0714.md`](paper/.laipaper/main0714.md). **Not** runtime policy. |
...
| 论文草稿和论文材料 | `docs/paper/`（布局见 `paper/README.md`；正文 `paper/.laipaper/main0714.md`） |
