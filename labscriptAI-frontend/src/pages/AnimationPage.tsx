...
import ProtocolOperationAnimator from '../components/ProtocolOperationAnimator';
...
const AnimationPage: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      >
        <Box sx={{ mb: { xs: 3, lg: 4 }, textAlign: 'center' }}>
          <Stack
            direction="row"
            alignItems="center"
        ...
        <Grid container spacing={{ xs: 2, lg: 2.5 }} alignItems="stretch">
          ...
          <Grid item xs={12} lg>
            <Paper
              ...
              sx={{
                position: 'relative',
                height: { xs: 680, lg: 'calc(100vh - 210px)' },
                minHeight: { xs: 680, lg: 720 },
                borderRadius: 1,
